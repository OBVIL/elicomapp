...
var alix = function() {
    ...
    /**
     * Include html fragment with one element by line
     */
    function ndhtml(id, url) {
        const div = document.getElementById(id);
        if (!div) {
            console.log("[Alix] ndhtml() not found <div id=\"" + id + "\">");
            return;
        }
        // default, clean dst, alt div.replaceChildren()
        div.innerText = '';
